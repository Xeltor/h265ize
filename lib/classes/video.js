...
class Video {
    ...
    filesystem() {
        ...
        return new Promise(function(resolve, reject) {
			...
			if (!fs.existsSync(path.dirname(_self.output.path))) {
				fs.mkdirSync(path.dirname(_self.output.path));
				fs.chmodSync(path.dirname(_self.output.path), '777');
			}
